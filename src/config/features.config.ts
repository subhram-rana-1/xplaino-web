...
export const FEATURES: FeatureConfig[] = [
  ...
  // ── PDF features ──────────────────────────────────────────────────────────
  {
    ...
    category: 'pdf',
    navTitle: 'AI PDF Chat & Annotator',
    navDescription: 'Chat with any PDF, annotate, use custom prompts, save conversations.',
    heading: 'Chat with PDF — AI-Powered PDF Reader & Annotator',
    headingHighlight: 'AI-Powered PDF Reader & Annotator',
    description:
      'Upload any PDF and turn it into an intelligent conversation. Ask questions, get summaries, annotate pages, apply custom AI prompts, and save every chat session for future reference. Study textbooks, research papers, contracts, and reports at 10× the speed — with an AI that actually understands your document.',
  ...
  },
  {
    ...
    navDescription: 'Highlight, add personal notes, comment, and collaborate on PDFs.',
