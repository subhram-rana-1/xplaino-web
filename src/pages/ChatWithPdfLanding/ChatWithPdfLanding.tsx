...
import { MessageSquare, Highlighter, Users, Upload, Bot, CheckCircle, FileText, RotateCcw, Lock } from 'lucide-react';
      ...
      <section className={styles.hero}>
        <div className={styles.heroLeft}>
          ...
          <div className={styles.secureRow}>
            ...
            <span className={styles.secureTag}>No sign up required</span>
            <span className={styles.secureTagDivider}>·</span>
            <span className={styles.secureTag}>No credit card</span>
          </div>
        </div>
